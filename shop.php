      ...
      <div class="container">
        <div class="row">
          <div class="display-header d-flex justify-content-between pb-3">
            <h1 class="display-7 text-dark text-uppercase">Products</h1>
          </div>
            <?php 
                    ...
                    while($row = $result->fetch_assoc()) { ?>
                        <div class="col-3 mb-5">
                            <div class="product-card position-relative">
                                ...
                                <img src="<?php echo $row['image_src'] ?>" alt="product-item" class="img-fluid">
                                </div>
                                ...
                                <h3 class="card-title text-uppercase">
                                    <a href="#"><?php echo $row['itleS'] ?></a>
                                </h3>
                                <span class="item-price text-primary"><?php echo $row['price'] ?> TND</span>
                                </div>
                            </div>
                        </div>
                    <?php }
